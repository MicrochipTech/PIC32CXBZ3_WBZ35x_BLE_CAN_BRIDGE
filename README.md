# PIC32CXBZ3_WBZ35x BLE to CAN Bridge using MCP251863
...
| TOOLS | QUANTITY |
| :- | :- |
| [PIC32CX-BZ3 and WBZ351 Curiosity Development Board](https://www.microchip.com/en-us/development-tool/ev19j06a) | 2 |
...
| WBZ351 | MCP251863 CLICK | Description        |    | WBZ351 | MCP251863 CLICK | Description |
| :-     | :-              | :-                 | :- | :-     | :-              | :-          |
| AN     | NC       	   | NC				    |    | PWM    | NC              | NC          |
| RST    | NC	           | NC     		    |    | INT    | NC              | NC          |
| CS     | 3(CS)           | CHIP SELECT        |    | RX     | NC              | NC          |
| SCK    | 4(SCK)          | SPI CLOCK          |    | TX     | NC              | NC          |
| MISO   | 5(MISO)         | SERIAL DATA OUTPUT |    | SCL    | 1(STB)          | StandBy Control|
| MOSI   | 6(MOSI)         | SERIAL DATA INPUT  |    | SDA    | 13(IN1)         | RX Interrupt|
...
- CAN-BLE Central Device
	...
	Refer the documentation available in [01_wbz351_mcp251863_CAN_BLE_Central](01_wbz351_mcp251863_CAN_BLE_Central/readme.md)
 
- CAN-BLE Peripheral Device

	Refer the documentation available in [02_wbz351_mcp251863_CAN_BLE_Peripheral](02_wbz351_mcp251863_CAN_BLE_Peripheral/readme.md)
...
- CAN-BLE Central Device
	- "01_wbz351_mcp251863_CAN_BLE_Central\firmware\bleCan_Central.X"
- CAN-BLE Peripheral Device	
	- "02_wbz351_mcp251863_CAN_BLE_Peripheral\firmware\bleCan_Peripheral.X"
...
- Program a WBZ351 Curiosity board with bleCan_Central application and other with WBZ351 Curiosity board with bleCan_Peripheralapplication.
...
![MCP251863_WBZ351_SETUP](Docs/can_ble_setup.png)
